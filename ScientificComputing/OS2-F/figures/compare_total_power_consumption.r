#library(devEMF)
baseDir <- "C:/users_local/krach/projects/cactos/files/04_Workpackages/WP_6/01_SimulationModels/D6.5/OS2-F-d6_5-final/"
...
pdf("powerconsumption_datacentre_os2-f.pdf", height = 4, width = 7)
...
legend(max.x - 5100, max.y, c("Predicted", "Measured"), lty=c(1,1), lwd=c(2.5,2.5), col=colors)
dev.off()